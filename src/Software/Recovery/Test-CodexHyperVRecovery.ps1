...
try {
    ...
    $required = @(
        ...
        'Software\Harness\SystemPrompts.ps1',
        'Software\Harness\InstallerUac.ps1',
        'Software\Harness\GuestInstallerUac.ps1',
        'Software\Harness\InstallerUacGate.ps1',
        ...
        'Software\Canaries\InstallerUacVerifier.cs',
        'Software\Canaries\InstallerUacVerifier.exe',
        ...
        'Software\Skill\references\system-prompts.md',
        ...
        'Software\Canaries\SystemPromptCanary.cs',
        'Software\Canaries\SystemPromptCanary.exe',
        'Software\Canaries\SystemPromptCanary.manifest',
        'Software\Canaries\system-prompt-actions.json',
        ...
        'Software\Harness\tests\Test-SystemPromptContract.ps1',
