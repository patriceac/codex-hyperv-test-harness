...
foreach ($requiredRecoveryPath in @('Software\Harness\RequestNetwork.ps1', 'Software\Harness\tests\Test-RequestNetworkPropagation.ps1', 'Software\Harness\tests\Test-RequestNetworkSafety.ps1', 'Software\Harness\tests\Test-RunnerContractValidation.ps1')) {
...
$scenarios.Add('recovery-bundle-requires-network-module-and-tests')
