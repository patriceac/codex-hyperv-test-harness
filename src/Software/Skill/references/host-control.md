...
- The screen halo turns amber while paused and the controlled-window outline keeps its violet identity color at reduced intensity. After ten uninterrupted seconds without physical input, the controller brings the tracked application back to the foreground, verifies that focus belongs to its process tree, restores the active visual intensity, and continues.
