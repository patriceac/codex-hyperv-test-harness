...
- Submit the canonical artifact path. Do not pre-copy payloads or manage worker VMs, checkpoints, networking, transport, or cleanup directly. Keep test VMs disconnected unless the test explicitly needs an enabled network profile.
