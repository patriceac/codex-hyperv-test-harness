...
if ($built.Count -ne 9 -or @($built | Where-Object { -not (Test-Path -LiteralPath $_.Output -PathType Leaf) }).Count -gt 0) {
    throw 'The nine C# canaries were not rebuilt successfully.'
}
