...
if ($built.Count -ne 11 -or @($built | Where-Object { -not (Test-Path -LiteralPath $_.Output -PathType Leaf) }).Count -gt 0) {
    throw 'The eleven C# canaries were not rebuilt successfully.'
}
