...
if ($built.Count -ne 8 -or @($built | Where-Object { -not (Test-Path -LiteralPath $_.Output -PathType Leaf) }).Count -gt 0) {
    throw 'The eight C# canaries were not rebuilt successfully.'
}
