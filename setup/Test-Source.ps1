...
if ($built.Count -ne 7 -or @($built | Where-Object { -not (Test-Path -LiteralPath $_.Output -PathType Leaf) }).Count -gt 0) {
    throw 'The seven C# canaries were not rebuilt successfully.'
}
